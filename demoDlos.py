...
parser.add_argument('--dataset', default='dlos', help='Dataset: dlos, sunrgbd or scannet [default: dlos]')
...
if __name__=='__main__':
    ...
    demo_dir = os.path.join(BASE_DIR, 'log_dlosFirstTest') 
    if FLAGS.dataset == 'sunrgbd':
        ...
        from dlos_detection_dataset import DC # dataset config
        checkpoint_path = os.path.join(demo_dir, 'checkpoint.tar')
        from dlos_detection_dataset
    else:
